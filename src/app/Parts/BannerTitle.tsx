...
const BannerTitle = (Props: bannerInfo) => {
    return (
        <div
            className="banner bg-gray-900 bg-cover bg-center min-h-[6rem] sm:min-h-[8rem] md:min-h-[8rem] lg:min-h-[10rem] xl:min-h-[12rem] 2xl:min-h-[16rem] py-8 bg-cover bg-center flex justify-center items-center" style={{backgroundImage: 'url(img/background-banner.jpg)'}}>
            <div
